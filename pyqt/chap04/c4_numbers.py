...
import c5_numberformatdlg1
import c5_numberformatdlg2
import c5_numberformatdlg3
...
class Form(QDialog):
	...
	def setNumberFormat1(self):
		dialog = c5_numberformatdlg1.NumberFormatDlg(self.format, self)
		if dialog.exec_():
	...
	def setNumberFormat2(self):
		dialog = c5_numberformatdlg2.NumberFormatDlg(self.format, self)
	...
	def setNumberFormat3(self):
		if self.numberFormatDlg is None:
			self.numberFormatDlg = c5_numberformatdlg3.NumberFormatDlg(
