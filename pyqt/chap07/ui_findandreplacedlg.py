...
#
# Created: Tue Aug 19 19:02:33 2014
...
class Ui_FindAndReplaceDlg(object):
    def setupUi(self, FindAndReplaceDlg):
        ...
        FindAndReplaceDlg.resize(400, 177)
        ...
        self.gridLayout_2.addWidget(self.findLineEdit, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.replaceLineEdit, 1, 1, 1, 1)
